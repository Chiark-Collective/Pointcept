...
data = dict(
    ...
    train=dict(
      type="LibraryDataset",
      split="train",
      data_root="data/clouds/res0.05_pr0.049/park_row",  # Optional, will use default if not specified
    ...
    val=dict(
        type="LibraryDataset",
        split="val",
        data_root="data/clouds/res0.05_pr0.049/park_row",
        glob_pattern="combined*.pth",
        transform=[
            dict(type="CenterShift", apply_z=True),
